    ...
    <section className="py-[60px] md:py-[80px] lg:py-[100px] bg-white overflow-hidden" id="about">
      <div className="max-w-[1280px] mx-auto px-5 md:px-10 lg:px-[40px]">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-[13px] font-bold tracking-[2px] text-brand uppercase mb-3 block">Why Choose Us</span>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-charcoal mb-6 leading-tight tracking-tight">
              A Real Estate Partner <br/> You Can Trust
            </h2>
            <p className="text-[18px] text-gray-500 mb-8 leading-relaxed">
              We don't just facilitate transactions; we build relationships. With over 15 years of experience and a client-first approach, we're dedicated to achieving your real estate goals.
            </p>
        </div>
