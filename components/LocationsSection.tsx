    ...
    <section className="py-[60px] md:py-[80px] lg:py-[100px] bg-gray-50 relative" id="areas">
      <div className="max-w-[1280px] mx-auto px-5 md:px-10 lg:px-[40px] relative z-10">
        <div className="text-center mb-10 md:mb-16">
           <span className="text-[13px] font-bold tracking-[2px] text-brand uppercase mb-3 block">Our Coverage</span>
           <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-charcoal mb-6 tracking-tight">Areas We Serve</h2>
           <p className="text-gray-500 text-lg max-w-2xl mx-auto">
             Local expertise with a broad reach. Click a location below to explore market insights and available homes.
           </p>
        </div>
