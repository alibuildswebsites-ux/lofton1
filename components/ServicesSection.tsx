    ...
    <section className="py-[60px] md:py-[80px] lg:py-[100px] bg-white relative overflow-hidden" id="services">
      ...
      <div className="max-w-[1280px] mx-auto px-5 md:px-10 lg:px-[40px] relative z-10">
        <div className="text-center mb-[40px] md:mb-[60px] lg:mb-[80px]">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-charcoal mb-6 tracking-tight leading-tight">
            Real Estate Solutions <br className="hidden md:block"/> Built Around You
          </h2>
          <p className="text-[18px] text-gray-500 font-normal max-w-2xl mx-auto leading-relaxed">
            Whether you're buying your first home, selling a luxury property, or building an investment portfolio, we provide the expertise to guide you.
          </p>
        </div>
