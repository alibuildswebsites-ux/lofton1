      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center py-20 px-5">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10">
            <h1 className="text-3xl font-bold text-charcoal mb-2 text-center">Create Account</h1>
            <p className="text-gray-500 text-center mb-8">Join Lofton Realty today</p>
            ...
            <button
              ...
              disabled={loading}
              className="w-full border border-gray-300 text-gray-700 py-3 rounded-lg font-semibold hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
            >
